...
export const tests: readonly TestCase[] = [
  {
    name: "P4/P6/P7 controller-only route drives real Space Rocks launch restart and exit",
    run: async () => {
      ...
      const controller = new ShellController({
        registry: new GameRegistry([SPACE_ROCKS_MODULE]),
      ...
      assert(host.activeGameId === null, "exit must release Space Rocks ownership");
